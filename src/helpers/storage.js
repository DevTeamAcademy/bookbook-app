...
export const setAuthToken = (token: string) => localStorage.setItem('accessToken', JSON.stringify(token)); // eslint-disable-line
...
export const setRefreshTokenToSession = (token: string) =>
